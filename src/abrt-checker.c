            ...
            jobject   exception_object)
{
    ...
    printf("The uncaught exception %s was caught by a native method!\n", rpt->exception_type_name);
    ...
    if (equal_objects && exception_is_intended_to_be_reported(jvmti_env, jni_env, rpt->exception_object, &(rpt->exception_type_name)))
    {
        jlong tid = 0;
        T_jthrowableCircularBuf *threads_exc_buf = NULL;
