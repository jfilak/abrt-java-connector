...
static jclass find_class_nothrow(
        JNIEnv     *jni_env,
        const char *fqdn_class_name)
{
    jclass class_obj = (*jni_env)->FindClass(jni_env, fqdn_class_name);
    /* Throws:
...
static jmethodID get_method_id_nothrow(
        JNIEnv      *jni_env,
        jclass      owning_class,
        const char  *method_name,
        const char  *method_type)
{
    jmethodID method_id = (*jni_env)->GetMethodID(jni_env, owning_class, method_name, method_type);
    /* Throws:
    ...
    {
        (*jni_env)->ExceptionClear(jni_env);
        VERBOSE_PRINT(__FILE__ ":" STRINGIZE(__LINE__)": GetMethodId(%s, %s) thrown an exception\n", method_name, method_type);
    }
...
static jobject call_object_method_nothrow(
        JNIEnv     *jni_env,
        jobject    obj,
        jmethodID  methodId,
        ...)
{
    va_list params;
    va_start(params, methodId);
    jobject object_out = (*jni_env)->CallObjectMethodV(jni_env, obj, methodId, params);
    va_end(params);

    if ((*jni_env)->ExceptionOccurred(jni_env))
    {
        (*jni_env)->ExceptionClear(jni_env);
        VERBOSE_PRINT(__FILE__ ":" STRINGIZE(__LINE__)": CallObjectMethod() thrown an exception\n");
    }
        ...
        jlong    *tid)
{
    ...
    jmethodID get_id = get_method_id_nothrow(jni_env, thread_class, "getId", "()J" );
    if (NULL == get_id)
    {
            ...
            JNIEnv   *jni_env)
{
    ...
    *space = 0;
    ...
    jclass cls = find_class_nothrow(jni_env, class_name);
    if (cls == NULL)
    {
        if (class_name != NULL)
        {
            ...
            const char *stringize_method_name)
{
    ...
    class_loader_class = find_class_nothrow(jni_env, "java/lang/ClassLoader");
    ...
    jmethodID get_resource = get_method_id_nothrow(jni_env, class_loader_class, "getResource", "(Ljava/lang/String;)Ljava/net/URL;");
    ...
    {
        (*jni_env)->ExceptionClear(jni_env);
        VERBOSE_PRINT(__FILE__ ":" STRINGIZE(__LINE__)": NewStringUTF(%s) thrown an exception\n", upd_class_name);
        goto get_path_to_class_class_loader_lcl_refs_cleanup;
    }

    /* call method ClassLoader.getResource(className) */
    jobject url = call_object_method_nothrow(jni_env, class_loader, get_resource, j_class_name);
    if (NULL == url)
        goto get_path_to_class_class_loader_lcl_refs_cleanup;

    /* find method URL.toString() */
    jclass url_class = find_class_nothrow(jni_env, "java/net/URL");
    if (NULL == url_class)
        goto get_path_to_class_class_loader_lcl_refs_cleanup;

    jmethodID to_external_form = get_method_id_nothrow(jni_env, url_class, stringize_method_name, "()Ljava/lang/String;");
    if (NULL == to_external_form)
        goto get_path_to_class_class_loader_lcl_refs_cleanup;

    /* call method URL.toString() */
    jstring jstr = (jstring)call_object_method_nothrow(jni_env, url, to_external_form);
    if (jstr ==  NULL)
        goto get_path_to_class_class_loader_lcl_refs_cleanup;
            ...
            JNIEnv   *jni_env)
{
    ...
    jclass class_loader_class = find_class_nothrow(jni_env, "java/lang/ClassLoader");
            ...
            const char *searched_class_name)
{
    ...
    jclass class_class = find_class_nothrow(jni_env, "java/lang/Class");
    if (NULL == class_class)
        goto find_class_in_loaded_class_cleanup;

    jmethodID get_name_method = get_method_id_nothrow(jni_env, class_class, "getName", "()Ljava/lang/String;");
    ...
    {
        jobject class_name = call_object_method_nothrow(jni_env, loaded_classes[i], get_name_method);
        if (NULL == class_name)
            continue;
            ...
            char           **class_fs_path)
{
    ...
    jmethodID get_class_name_method = get_method_id_nothrow(jni_env, stack_frame_class, "getClassName", "()Ljava/lang/String;");
    ...
    jstring class_name_of_frame_method = call_object_method_nothrow(jni_env, stack_frame, get_class_name_method);
    ...
    jclass class_of_frame_method = find_class_nothrow(jni_env, cls_name_str);
    ...
    jmethodID to_string_method = get_method_id_nothrow(jni_env, stack_frame_class, "toString", "()Ljava/lang/String;");
    (*jni_env)->DeleteLocalRef(jni_env, stack_frame_class);
    ...
    jobject orig_str = call_object_method_nothrow(jni_env, stack_frame, to_string_method);
    if (orig_str == NULL)
    {
            ...
            char     **executable)
{
    ...
    jmethodID to_string_method = get_method_id_nothrow(jni_env, exception_class, "toString", "()Ljava/lang/String;");
    if (to_string_method == NULL)
    {
    ...
    jobject exception_str = call_object_method_nothrow(jni_env, exception, to_string_method);
    ...
    jmethodID get_stack_trace_method = get_method_id_nothrow(jni_env, exception_class, "getStackTrace", "()[Ljava/lang/StackTraceElement;");
    (*jni_env)->DeleteLocalRef(jni_env, exception_class);
    ...
    jobject stack_trace_array = call_object_method_nothrow(jni_env, exception, get_stack_trace_method);
            ...
            char     **executable)
{
    ...
    jmethodID get_cause_method = get_method_id_nothrow(jni_env, exception_class, "getCause", "()Ljava/lang/Throwable;");
    (*jni_env)->DeleteLocalRef(jni_env, exception_class);
    ...
    jobject cause = call_object_method_nothrow(jni_env, exception, get_cause_method);
    while (NULL != cause)
    {
        ...
        jobject next_cause = call_object_method_nothrow(jni_env, cause, get_cause_method);
        (*jni_env)->DeleteLocalRef(jni_env, cause);
        cause = next_cause;
    }
